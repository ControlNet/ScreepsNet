...
class Traveler {
    ...
    static findTravelPath(origin, destination, options = {}) {
        ...
        if (ret.incomplete && options.ensurePath) {
            if (options.useFindRoute === undefined) {
                // handle case where pioneer failed at a short distance due to not using findRoute
    ...
    /**
     * find a viable sequence of rooms that can be used to narrow down pioneer's search algorithm
     * @param origin
     * @param destination
     * @param options
     * @returns {{}}
