...
declare class MockedWorld {
    ...
    /**
     ...
     This function does NOT generate terrain memory
     */
    ...
    /**
     Return room terrain memory (walls, plains and swamps)
     Return a TerrainMatrix instance
     */
    getTerrain(room: string): Promise<MockedTerrainMatrix>;
    /**
     Define room terrain memory (walls, plains and swamps)
    ...
    /**
     Reset world memory to a barren world with no rooms, but with invaders and source keepers users
     */
    reset(): Promise<void>;
    /**
...
declare class MockedUser {
    ...
    /**
     Return the current value of the requested user memory
     */
